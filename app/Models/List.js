  ...
  <div class="card bg-secondary text-light">
    <div class="card-body">
      ...
      <form onsubmit="app.listController.addListItem(event, '${this.id}')">
        ...
        <button class="btn-small btn-primary" type="submit">Add Item</button>
      </form>
      <button class="btn btn-danger" onclick="app.listController.removeList('${this.id}')">Delete List</button>
    </div>
  </div>
</div>
    `;
